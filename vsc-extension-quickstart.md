...
--vscode-editor-font-family:Operator Mono Lig;
...
--vscode-editorInlayHint-background:#f3eff5;
...
--vscode-testing-message\.warning\.decorationForeground:#ffe45e;
--vscode-testing-message\.warning\.lineBackground:rgba(255, 208, 0, 0.2);
--vscode-testing-message\.info\.decorationForeground:#5eadf2;
...
--vscode-notebook-outputContainerBackgroundColor:rgba(243, 239, 245, 0.13);
